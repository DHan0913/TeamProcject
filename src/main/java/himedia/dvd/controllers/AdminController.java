...
public class AdminController {
	...
	public String issuedCoupon(@RequestParam("couponId") Long couponId, @RequestParam("userNo") Long userNo,
	...
	public String getTotalRank(Model model) {
		...
		String totalAmt = totalService.getTotalAmt(); // 총 매출액
		List<TotalVo> total = totalService.getTotalRank(); // 상품 순위
		List<TotalVo> usrList = totalService.getUsrList(); // 사용자 순위
		long calculatedCouponCount = totalService.getCalculatedCouponCount(); // 쿠폰 금액 계산
